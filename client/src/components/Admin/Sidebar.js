    ...
    return (
        ...
        >
            ...
            >
                ...
                <Link to="/manageques" style={{ textDecoration: "none" }}>
                    <CTypography> Manage Question </CTypography>
                </Link>
                <Link to="/managequiz" style={{ textDecoration: "none" }}>
                    <CTypography> Manage Quiz</CTypography>
                </Link>
