        ...
        <div style={{
            ...
            <Box sx={{
                ...
                <Grid 
                    ...
                    <Grid item xs={12} sm={6} md={6} lg={3}>
                        <img src={require("../assets/pic_1.svg").default} style={{
                            width: '90%'
                        }}/>
                    </Grid>
                    <Grid item xs={12} sm={6} md={6} lg={3}>
                        <img src={require("../assets/pic_2.svg").default} style={{
                            width: '90%'
                        }}/>
                    </Grid>
                    <Grid item xs={12} sm={6} md={6} lg={3}>
                        <img src={require("../assets/pic_3.svg").default} style={{
                            width: '90%'
                        }}/>
                    </Grid>
                    <Grid item xs={12} sm={6} md={6} lg={3}>
                        <img src={require("../assets/pic_4.svg").default} style={{
                            width: '90%'
                        }}/>
                    </Grid>
                </Grid>
